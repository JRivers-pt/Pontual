$recordsFile1 = "C:\Users\JD\Documents\Pontual\Relatorios\CurrentData_AllDepts_260526_to_260625_7502.xls"
$recordsFile2 = "C:\Users\JD\Documents\Pontual\Relatorios\Records_AllDepts_260526_to_260625_7502.xls"
$outputDir = "C:\Users\JD\Documents\Pontual\Relatorios"

$startDate = Get-Date "2026-05-26"
$endDate = Get-Date "2026-06-25"
    ...
    if ($isGrid) {
        ...
        foreach ($rm in $rowMatches) {
            ...
            if ($id -match '^\d+$') {
                ...
                if ($name -match '(?i)jd|joão|joao|gestor|gerente|admin') { continue }
...
$htmlFile = Join-Path $outputDir "Relatorio_CC_Junho.html"
$csvFile = Join-Path $outputDir "Relatorio_CC_Junho.csv"
...
$pdfFile = "C:\Users\JD\Documents\Relatorio Junho CCGengibre.pdf"
...
if (Test-Path $edgePath) {
    ...
    Write-Host "Aviso: Microsoft Edge não encontrado em $edgePath. PDF não gerado automaticamente."
}
